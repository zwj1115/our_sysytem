...
cmake  -DCMAKE_BUILD_TYPE=Release  -DCMAKE_INSTALL_PREFIX="/home/slam/Thirpart/opencv-4.2.0/install" 
-DOPENCV_EXTRA_MODULES_PATH="/home/slam/Thirpart/opencv-4.2.0/opencv_contrib-4.2.0/modules"  -DWITH_QT=ON 
-DWITH_GTK=OFF -DWITH_OPENGL=ON -DWITH_TBB=ON  -DWITH_V4L=ON  -DWITH_CUDA=ON -DWITH_CUBLAS=ON -DWITH_CUFFT=ON 
-DCUDA_FAST_MATH=ON -DWITH_CUDNN=ON -DOPENCV_DNN_CUDA=ON  -DCUDA_ARCH_BIN="5.3 6.0 6.1 7.0 7.5 8.6" 
-DBUILD_opencv_cudacodec=OFF -DENABLE_FAST_MATH=1 -DBUILD_NEW_PYTHON_SUPPORT=ON -DBUILD_DOCS=OFF -DBUILD_TESTS=OFF 
-DBUILD_PERF_TESTS=OFF -DINSTALL_PYTHON_EXAMPLES=OFF -DINSTALL_C_EXAMPLES=OFF  -DBUILD_EXAMPLES=OFF  
-DOPENCV_ENABLE_NONFREE=ON -DBUILD_opencv_java=OFF -DBUILD_opencv_python3=ON -Wno-deprecated-gpu-targets ..    
