...
SCRIPT_DIR=$( cd -- "$( dirname -- "${BASH_SOURCE[0]}" )" &> /dev/null && pwd ) # get script dir (this should be the main folder directory of system)
...
# now install system module
cd ros_ws/src
if [ ! -L plvs ]; then
    print_blue "installing system module... "
    ln -s ../../Examples_old/ROS/our system
fi
