...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "Layer.proto", schemas, file_default_instances, TableStruct::offsets,
...
LayerProto::LayerProto()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_Layer_2eproto::scc_info_LayerProto.base);
  SharedCtor();
...
const LayerProto& LayerProto::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_Layer_2eproto::scc_info_LayerProto.base);
