...
#  ./mono_euroc path_to_vocabulary path_to_settings path_to_sequence_folder_1 path_to_times_file_1 (path_to_image_folder_2 path_to_times_file_2 ... path_to_image_folder_N path_to_times_file_N) (trajectory_file_name)" << endl;

$DEBUG_PREFIX ../Examples$SUFFIX/Monocular/mono_euroc$SUFFIX \
	../Vocabulary/ORBvoc.txt \
	../Examples$SUFFIX/Monocular/$EUROC_YAML \
	$PATH_TO_SEQUENCE_FOLDER \
	../Examples$SUFFIX/Monocular/EuRoC_TimeStamps/$SEQUENCE'.txt' \
	$OUTPUT_BASE_NAME
